#!/usr/bin/env python3
"""
pyidevice IDB UI自动化示例

这个示例展示了如何使用 pyidevice 的 IDB 集成进行 UI 自动化，
提供与 uiautomator2 相似的 API 体验。
...
def main():
    ...
    try:
        ...
        # 1. 坐标点击（类似uiautomator2的d.click(x, y)）
        print("\n👆 坐标点击测试...")
        ...
        print("\n📸 截图测试...")
        screenshot_path = idb.screenshot("idb_ui_automation_screenshot.png")
        if screenshot_path:
